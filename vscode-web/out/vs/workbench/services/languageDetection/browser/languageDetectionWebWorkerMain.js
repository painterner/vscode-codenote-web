...
var $M3b = class _$M3b {
  ...
  static getChannel(workerServer) {
    return workerServer.getChannel(_$M3b.CHANNEL_NAME);
  }
  static setChannel(workerClient, obj) {
    workerClient.setChannel(_$M3b.CHANNEL_NAME, obj);
  }
};
...
var $mKc = class _$mKc {
  ...
  constructor(workerServer) {
    ...
    this.g = $M3b.getChannel(workerServer);
  ...
  async p() {
    ...
    const { ModelOperations } = await $qF(uri, "");
