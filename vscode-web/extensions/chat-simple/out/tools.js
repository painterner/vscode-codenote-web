...
exports.RunInTerminalTool = exports.DeleteFilesTool = exports.ModifyFilesTool = exports.CreateFilesTool = exports.FindFilesTool = exports.TabCountTool = void 0;
...
function registerChatTools(context) {
    ...
    context.subscriptions.push(vscode.lm.registerTool('chat-tools-sample_createFiles', new CreateFilesTool()));
    context.subscriptions.push(vscode.lm.registerTool('chat-tools-sample_modifyFiles', new ModifyFilesTool()));
    context.subscriptions.push(vscode.lm.registerTool('chat-tools-sample_deleteFiles', new DeleteFilesTool()));
    context.subscriptions.push(vscode.lm.registerTool('chat-tools-sample_runInTerminal', new RunInTerminalTool()));
}
class TabCountTool {
    async invoke(options, _token) {
        const params = options.input;
        console.log("invoke tabcount toolllllllllllllllllllllllllllllllllllllllllll");
...
exports.CreateFilesTool = CreateFilesTool;
class ModifyFilesTool {
    async invoke(options, token) {
        const params = options.input;
        const files = await vscode.workspace.findFiles(params.pattern, '**/node_modules/**', undefined, token);
        const strFiles = files.map((f) => f.fsPath).join('\n');
...
exports.DeleteFilesTool = DeleteFilesTool;
