...
class ToolResultElement extends prompt_tsx_1.PromptElement {
    async render(state, sizing) {
        ...
        console.log("toolResult tooooooooooooooooooooooooooooooo", toolResult.content);
...
class PromptReferenceElement extends prompt_tsx_1.PromptElement {
    async render(_state, _sizing) {
        ...
        if (value instanceof vscode.Uri) {
            fsRelativePath = (0, utils_1.excludeWorkspacePrefix)(value.fsPath);
        }
        else if (value instanceof vscode.Location) {
            fsRelativePath = (0, utils_1.excludeWorkspacePrefix)(value.uri.fsPath);
        }
